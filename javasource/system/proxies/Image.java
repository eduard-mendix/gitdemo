...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MasterData.IncidentReportPhoto", mendixObject.getType()))
			return masterdata.proxies.IncidentReportPhoto.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("IoT.Room", mendixObject.getType()))
