...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("PushNotifications.APNSCertificate", mendixObject.getType()))
			return pushnotifications.proxies.APNSCertificate.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("PushNotifications.APNSToken", mendixObject.getType()))
			return pushnotifications.proxies.APNSToken.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MasterData.BillDOCX", mendixObject.getType()))
			return masterdata.proxies.BillDOCX.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MasterData.BillImportFile", mendixObject.getType()))
			return masterdata.proxies.BillImportFile.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MasterData.BillPDF", mendixObject.getType()))
			return masterdata.proxies.BillPDF.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("PushNotifications.FCMPrivateKey", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("IoT.Json", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("WorkflowEssentialsPublic.WorkflowAttachment", mendixObject.getType()))
