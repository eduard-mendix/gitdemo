...
public class Connector
{
	 ...
	 */
	public static final java.lang.String entityName = "IoT.Connector";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "IoT.Connector"));
	}
	...
	protected Connector(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject connectorMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("IoT.Connector", connectorMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a IoT.Connector");
	...
	public static iot.proxies.Connector initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return iot.proxies.Connector.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static iot.proxies.Connector initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new iot.proxies.Connector(context, mendixObject);
	}

	public static iot.proxies.Connector load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return iot.proxies.Connector.initialize(context, mendixObject);
	}

	public static java.util.List<iot.proxies.Connector> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<iot.proxies.Connector> result = new java.util.ArrayList<iot.proxies.Connector>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//IoT.Connector" + xpathConstraint))
			result.add(iot.proxies.Connector.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final iot.proxies.Connector that = (iot.proxies.Connector) obj;
