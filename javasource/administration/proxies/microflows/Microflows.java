...
public class Microflows
{
	...
	public static void newServiceEngineer(IContext context)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		Core.microflowCall("Administration.NewServiceEngineer").withParams(params).execute(context);
	}
	/**
	...
	public static void saveNewServiceEngineer(IContext context, administration.proxies.AccountPasswordData _accountPasswordData)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("AccountPasswordData", _accountPasswordData == null ? null : _accountPasswordData.getMendixObject());
		Core.microflowCall("Administration.SaveNewServiceEngineer").withParams(params).execute(context);
	}
