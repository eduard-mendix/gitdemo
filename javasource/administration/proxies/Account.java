...
public class Account extends system.proxies.User
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MasterData.Customer", mendixObject.getType()))
			return masterdata.proxies.Customer.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MasterData.ServiceEngineer", mendixObject.getType()))
