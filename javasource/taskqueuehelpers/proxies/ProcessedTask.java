...
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject processedTaskMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "TaskQueueHelpers.ProcessedTask";
	...
	public enum MemberNames
	{
		...
		OriginalMendixId("OriginalMendixId");
	...
	public ProcessedTask(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, "TaskQueueHelpers.ProcessedTask"));
	}

	protected ProcessedTask(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject processedTaskMendixObject)
	{
		if (processedTaskMendixObject == null)
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		if (!com.mendix.core.Core.isSubClassOf("TaskQueueHelpers.ProcessedTask", processedTaskMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a TaskQueueHelpers.ProcessedTask");

		this.processedTaskMendixObject = processedTaskMendixObject;
		this.context = context;
	}

	/**
	 * @deprecated Use 'ProcessedTask.load(IContext, IMendixIdentifier)' instead.
	 */
	@java.lang.Deprecated
	public static taskqueuehelpers.proxies.ProcessedTask initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return taskqueuehelpers.proxies.ProcessedTask.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static taskqueuehelpers.proxies.ProcessedTask initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new taskqueuehelpers.proxies.ProcessedTask(context, mendixObject);
	}

	public static taskqueuehelpers.proxies.ProcessedTask load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return taskqueuehelpers.proxies.ProcessedTask.initialize(context, mendixObject);
	}
	 ...
	 * @param status
	 */
	public final taskqueuehelpers.proxies.TaskStatus getStatus()
	{
	 ...
	 */
	public final taskqueuehelpers.proxies.TaskStatus getStatus(com.mendix.systemwideinterfaces.core.IContext context)
	{
		Object obj = getMendixObject().getValue(context, MemberNames.Status.toString());
		if (obj == null)
			return null;

		return taskqueuehelpers.proxies.TaskStatus.valueOf((java.lang.String) obj);
	}
	 ...
	 * @param status
	 */
	public final void setStatus(taskqueuehelpers.proxies.TaskStatus status)
	{
	 ...
	 * @param status
	 */
	public final void setStatus(com.mendix.systemwideinterfaces.core.IContext context, taskqueuehelpers.proxies.TaskStatus status)
	{
		if (status != null)
	...
	/**
	 * @return value of StatusString
	 */
	public final java.lang.String getStatusString()
	{
		return getStatusString(getContext());
	}
	 ...
	 * @return value of StatusString
	 */
	public final java.lang.String getStatusString(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.String) getMendixObject().getValue(context, MemberNames.StatusString.toString());
	}

	/**
	 * Set value of StatusString
	 * @param statusstring
	 */
	public final void setStatusString(java.lang.String statusstring)
	{
		setStatusString(getContext(), statusstring);
	}
	 ...
	 * @param statusstring
	 */
	public final void setStatusString(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String statusstring)
	{
		getMendixObject().setValue(context, MemberNames.StatusString.toString(), statusstring);
	}

	/**
	 * @return value of OriginalMendixId
	 */
	public final java.lang.Long getOriginalMendixId()
	{
		return getOriginalMendixId(getContext());
	}
	 ...
	 * @return value of OriginalMendixId
	 */
	public final java.lang.Long getOriginalMendixId(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.Long) getMendixObject().getValue(context, MemberNames.OriginalMendixId.toString());
	}

	/**
	 * Set value of OriginalMendixId
	 * @param originalmendixid
	 */
	public final void setOriginalMendixId(java.lang.Long originalmendixid)
	{
		setOriginalMendixId(getContext(), originalmendixid);
	}
	 ...
	 * @param originalmendixid
	 */
	public final void setOriginalMendixId(com.mendix.systemwideinterfaces.core.IContext context, java.lang.Long originalmendixid)
	{
		getMendixObject().setValue(context, MemberNames.OriginalMendixId.toString(), originalmendixid);
	}
	...
	{
		return processedTaskMendixObject;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final taskqueuehelpers.proxies.ProcessedTask that = (taskqueuehelpers.proxies.ProcessedTask) obj;
	...
	{
		return "TaskQueueHelpers.ProcessedTask";
	}
